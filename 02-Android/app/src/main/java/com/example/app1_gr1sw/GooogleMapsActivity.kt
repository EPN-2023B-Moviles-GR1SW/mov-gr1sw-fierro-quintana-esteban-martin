...
class GooogleMapsActivity : AppCompatActivity() {
    ...
    fun mostrarSnackbar(texto:String){
        Snackbar.make(findViewById(R.id.cl_google_maps),texto,Snackbar.LENGTH_LONG).show()
    }
    ...
    fun escucharListeners(){
        ...
        mapa.setOnPolylineClickListener {
            mostrarSnackbar("setonpolylineClickListenr ${it.tag}")
            it.tag
        }
        ...
        mapa.setOnCameraMoveListener { Log.i("mapa","setOnCameraMOveListener") }
        mapa.setOnCameraMoveStartedListener {Log.i("mapa","setOnCameraMOveStratedListener ${it}")   }

        mapa.setOnCameraIdleListener { Log.i("mapa","setOnCameraIDleListener") }
    }
    fun anadirPolilinea(){
        with(mapa){
            val poliLineaUno = mapa
                .addPolyline(PolylineOptions().clickable(true).add(
    ...
    fun anadirPoligono(){
        with(mapa){
            val poligonoUno = mapa
                .addPolygon(PolygonOptions().clickable(true).add(
