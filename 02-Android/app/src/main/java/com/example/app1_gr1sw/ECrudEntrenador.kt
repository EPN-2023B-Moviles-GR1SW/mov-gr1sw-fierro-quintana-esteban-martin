...
class ECrudEntrenador : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonBuscarBDD.setOnClickListener {
            val id = findViewById<androidx.appcompat.widget.AppCompatEditText>(R.id.input_id)
            val nombre =
                findViewById<androidx.appcompat.widget.AppCompatEditText>(R.id.input_nombre)
            val descripcion =
                findViewById<androidx.appcompat.widget.AppCompatEditText>(R.id.input_descripcion)
            val entrenador =
